(function () {
    ...
    function _scroll(obj) {
        ...
        else if (scdir === 'left' && (offsetX === 2 * stepX || offsetX === stepX)) {
            offsetX -= stepX;
        }
    ...
    function _swipe(obj) {
        ...
        obj.addEventListener('touchend', function (e) {
            ...
            if (elT <= alT) {
                ...
                if (obj.id === 'slides') {
                    if (swdir === 'up' && obj.style.transform !== 'translateY(-1536)') {
                        scdir = swdir;
                        _scroll(obj);
    ...
    function dragElement(elmnt, obj) {
        var pos1 = 0,
            ...
            toggle_start = -parseInt(getComputedStyle(document.querySelector('.toggle_obj')).width) / 2,
        ...
        function elementDrag(e) {
            ...
            if (new_pos >= toggle_start && new_pos <= toggle_end) { 
                ...
                if ((new_pos <= scroll_point2 && elmnt.offsetLeft > scroll_point2) ||
        ...
        function closeDragElement() { 
            ...
            // TOGGLE LINE
            toggle_line.style.width = parseInt(elmnt.style.left) - toggle_start + 'px';
